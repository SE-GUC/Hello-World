...
router.post('/board-members/:id',async(req,res)=>{
    try {
        ...
        return res.json({msg:'Board Member successfully added', data: consultant.boardMembers});
    }
    catch(error) {
...
router.post('/events/:id',async(req,res)=>{
    try {
        ...
        return res.json({msg:'Event successfully added', data: consultant.events});
    }
    catch(error) {
        return res.status(404).json({ consultantnotfound: 'consultant not found' });
    }
...
router.post('/partners/:id/:id2',async(req,res)=>{
    try {
        ...
        return res.json({msg:'Partner successfully added', data: consultant.partners});
    }
    catch(error) {
        return res.status(404).json({ consultantnotfound: 'Consultant not found' });
    }
...
>>>>>>> task
        ...
        return res.json({msg:'Report successfully added', data: consultant.reports});
    }
    catch(error) {
        return res.status(404).json({ reportnotfound: 'Consultant not found' });
    }
});
...
router.delete('/board-members/:id',async(req,res)=>{
    try {
        ...
        consultant.boardMembers.splice( consultant.boardMembers.indexOf(boardMember), 1 );
...
router.delete('/:id',async (req,res)=>{
    ...
    res.json({msg:'deleted', data: deletedConsultant})
});
